...
createFlowstileWorker({
  process: [orderFulfillmentProcess, loanOriginationProcess, expenseApprovalProcess],
  flowstile: {
  ...
  activities: { processPayment, refundPayment, cancelShipment, fetchCreditScore, recordReimbursement },
}).catch((err) => {
